describe("alignment testing commands", () => {
  describe("horizontal", () => {
    before(() => {
      cy.visit("cypress/fixtures/horizontal.html");
    });
    ...
    it("block-4 should be horizontally aligned bottom with block-3", () => {
      cy.get(".block-4").should("be.horizontallyAligned", ".block-3", "bottom");
    });
  ...
  describe("vertical", () => {
    before(() => {
      cy.visit("cypress/fixtures/vertical.html");
    });
    ...
    it("block-8 should be vertically aligned centered with block-7", () => {
      cy.get(".block-8").should("be.verticallyAligned", ".block-7", "centered");
    });
  });
});
